...
?>
    <nav class="navbar fixed-top navbar-expand-lg">
        ...
        <a class="navbar-brand text-white" href="index.php">Wishipping</a>
...
<?php       } ?>
            ...
            <form action="search.php" class=' d-flex justify-content-center ' method="POST"><!-- Search form -->
                <div class="searchbar-nav">
                <input class="form-control mr-sm-2 " type="search" name="search" placeholder="Search" aria-label="Search">
                <button class="btn btn-color my-2 my-sm-0" type="submit"><i class="fa fa-search"></i></button>
                </div>
            </form>
            </ul>
...
<?php            }else{ ?>
            ...
            <ul class="navbar-nav log-butt log mr-right">
                <li><a id="login"  href="login.php">Se connecter/S'inscrire</a></li>
            </ul>
<?php            }
?>
